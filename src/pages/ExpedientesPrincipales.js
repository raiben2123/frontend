...
import MainExpedientesPrincipales from "../components/MainExpedientesPrincipales"

const ExpedientesPrincipales = () => {
    ...
    return (
        <div id="Home">
            ...
            <div id="Contenido" style={{ display: "flex" }}>
                ...
                <MainExpedientesPrincipales className={isSidebarOpen ? 'sidebar-visible' : 'sidebar-hidden'} /> {/* Cambiar clase */}
            </div>
        </div>
    );
};

export default ExpedientesPrincipales;