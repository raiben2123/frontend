...
const MainDepartamentos = ({ className }) => {
    ...
    const mutationAdd = useMutation({
        mutationFn: (newDepartamento) => 
            fetch('http://localhost:9000/api/departamentos', {
                method: 'POST',
                headers: {
    ...
    const mutationUpdate = useMutation({
        mutationFn: (updatedDepartamento) => 
            fetch(`http://localhost:9000/api/departamentos/${updatedDepartamento.id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const mutationDelete = useMutation({
        mutationFn: (id) => 
            fetch(`http://localhost:9000/api/departamentos/${id}`, {
                method: 'DELETE',
            }),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['departamentos'] });
